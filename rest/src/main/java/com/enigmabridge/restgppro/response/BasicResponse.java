/*
 * Copyright (c) 2018 Enigma Bridge Ltd.
 *
 ...
 */
public class BasicResponse implements GeneralResponse {
    private BasicResponseData data = null;
    ...
    public void setResponse(GeneralResponseData data) {
        this.data = (BasicResponseData) data;
