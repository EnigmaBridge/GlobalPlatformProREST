...
import com.enigmabridge.restgppro.response.data.StatsResponseData;
import com.enigmabridge.restgppro.utils.CommonFnc;

/**
 * Created by Enigma Bridge Ltd (dan) on 13/01/2017.
 */
public class StatsResponse implements GeneralResponse {
    /**
    ...
    private int status;
    private StatsResponseData data = null;
    ...
    public void setResponse(GeneralResponseData data) {
        this.data = (StatsResponseData)data;
    }
