...
class FuncEncrypt(threading.Thread):
    ...
    def run(self):
        output_file = open("par_decrypt_" + str(self.name) + ".txt", "w")
        ...
        while runs < 1000:
            ...
            try:
                ...
                req = requests.post('http://localhost:8081/api/v1/mpc/run', headers=headers,
...
if __name__ == "__main__":
    ...
    for testing in range(0, threads):
        th_list.append(FuncEncrypt(args=[testing]))
